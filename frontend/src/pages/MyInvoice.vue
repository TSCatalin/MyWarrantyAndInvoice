...
<template>
  ...
  <main>
    <div
      class="items-center justify-center grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 px-[calc(5%)] md:px-[calc(10%)] lg:px-[calc(12%)] place-items-center py-2"
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div class="px-4 py-4">
            ...
            <div class="text-md text-neutral-400 mb-4 flex">
              <div class="font-semibold">
              {{inov.currency}} - {{ inov.value }} 
              </div>
            </div>
